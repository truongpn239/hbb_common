...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("HelpDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rs.truongit.net"];
pub const RS_PUB_KEY: &str = "AAAAC3NzaC1lZDI1NTE5AAAAIDn2gRoXk0yxHlaVCDy0FpIU0YA+TakTlqMXpuVCjBUV";
